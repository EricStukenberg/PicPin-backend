...
class SearchTermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search_term" do
    assert_difference('SearchTerm.count') do
      post search_terms_url, params: { search_term: { result: @search_term.result, term: @search_term.term } }, as: :json
    end
  ...
  test "should update search_term" do
    patch search_term_url(@search_term), params: { search_term: { result: @search_term.result, term: @search_term.term } }, as: :json
    assert_response 200
  end
